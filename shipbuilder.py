...
class maksship():
    ...
    def __init__(self, reload="ignore", size="random", shiptype="random", fueluse=0, ):
        ...
        if reload != "ignore":
            self.ammo = reload["ammo"]
            self.crewcapacity = reload["crew capacity"]
            self.crew = reload["crew"]
            self.health = reload["health"]
            self.maxammo = reload["maxammo"]
            self.maxhealth = reload["maxhealth"]
            self.fueluse = reload["fueluse"]
            self.hold = reload["hold"]
            self.shiptype = reload["shiptype"]
