...
class battle:
    ...
    def __init__(self, ship1, ship2):
        ...
        #     command = input("=")
        #     self.commands(ship1, ship2, cont, command)
    ...
    def commands(self, ship1, ship2, cont, command):
        if cont:
            ...
            if command == "a" and ship1.ammo > 0:
                if randint(0, 4) > 0:
                    ...
                    ship1.ammo -= 1
                    ship2.crew -= randint(int(ship2.crew / 10) + 1, int(ship2.crew / 9) + 1)
                else:
                    print("Player Missed")
                    ship1.ammo -= 1
            elif command == "b":
    ...
    def arty(self, ship1, ship2, cont):
        if cont and ship2.ammo > 2:
            if randint(0, 4) > 0:
                ...
                ship2.ammo -= 1
                ship1.crew -= randint(int(ship1.crew / 10) + 1, int(ship1.crew / 9) + 1)
            else:
                print("Enemy Missed")
            return [ship1, ship2]
